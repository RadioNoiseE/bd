...
let res = parse "{\"title\": \"Cities\", \"cities\":[{\"name\": \"Chicago\", \"zips\": 60601}, {\"name\": \"New York\", \"zips\": 10004}]}";;

print_string (res |> get_child "cities" |> get_mem 1 |> get_child "name" |> as_string);;
